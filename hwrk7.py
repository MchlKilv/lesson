...
one_str = "пара-ра-рам рам-пам-папам па-ра-па-да"
two_str = "парам па"


def rhytm_info(str):
    a_val = set(map(lambda ch: ch.count("а"), str.split()))
    if len(a_val) == 1:
        print("Парам пам-пам")
    else:
        print("Пам парам")
...
def print_operation_table(operation, num_rows=11, num_columns=10):
    # максимально цифр числа
    ...
    for i in range(1, num_rows + 1):
        ...
        for j in range(1, num_columns + 1):
            ...
            format_result = str(result).ljust(max_length)
            row.append(format_result)
